...
def save_checkpoint(checkpoint_type: str, paths: Paths, model, optimizer, *, model_type,
    ...
    def helper(path_dict, is_named):
        ...
        model.save(f"/content/drive/My Drive/Wavenet Training/{model_type}/model.pyt")
        torch.save(optimizer.state_dict(), f"/content/drive/My Drive/Wavenet Training/{model_type}/optim.pyt")
