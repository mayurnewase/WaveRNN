...
wav_path = '/content/WaveRNN/dataset/lj_speech_dataset'
data_path = '/home/mayur/projects/datasets/rick_morty/tacotron_training_one_example_processed'
...
tts_checkpoint_every = 200        # checkpoints the model every X steps
